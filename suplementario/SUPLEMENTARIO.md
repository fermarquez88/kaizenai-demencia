...
**Trayectorias cognitivas longitudinales y predicción de la progresión a demencia desde la evaluación basal en una clínica de memoria argentina.**
...
**Imputación y datos faltantes.** El predictor primario (recuerdo diferido de relatos) faltó en 13/140 (9%) de la cohorte leve-moderado; se imputó por la mediana **dentro** de cada pliegue de la validación cruzada. Casos completos: 127/35, con AUC concordante.

**Calibración.** Modelo primario: pendiente de calibración 0,88; Brier 0,21; el ajuste con ponderación por clases sobre-estima el riesgo absoluto (intercepto de calibración global ≈ −0,19), recalibrado por Platt en el despliegue. La herramienta se interpreta como **estratificador de riesgo relativo por terciles**, no como calculadora de probabilidad individual exacta.
...
## S2. Tabla S1 — Trayectoria por test (RCI basado en regresión) con corrección FDR
...
| Figura de Rey · reproducción diferida | memoria | 195 | -0,09 | 12 | 6 | 10 | 0,083 | 0,283 |
...
| Memoria de Relatos · recuerdo diferido | memoria | 205 | -0,04 | 25 | 11 | 34 | 0,276 | 0,427 |
| Memoria de Relatos · recuerdo inmediato | memoria | 206 | -0,03 | 10 | 6 | 3 | 0,561 | 0,641 |
| Búsqueda de Símbolos (WAIS IV) | velocidad | 31 | -0,02 | 6 | 6 | 0 | 0,806 | 0,868 |
| Lista de Rey · recuerdo diferido | memoria | 236 | -0,01 | 15 | 11 | 24 | 0,868 | 0,868 |
...
Entre los amnésicos, el mecanismo predominante es el de almacenamiento (patrón de codificación/consolidación, sugestivo de compromiso temporal medial):
...
| Basal ↓ / Reeval → | Normal | DCL/leve | Leve-mod | Moderado | Mod-grave | Grave |
|---|---|---|---|---|---|---|
| **Normal** | 9 | 7 | 1 | 0 | 0 | 0 |
| **DCL/leve** | 6 | 60 | 12 | 15 | 1 | 2 |
| **Leve-mod** | 0 | 12 | 13 | 13 | 5 | 1 |
| **Moderado** | 0 | 1 | 2 | 31 | 6 | 8 |
| **Mod-grave** | 0 | 0 | 0 | 2 | 2 | 4 |
| **Grave** | 0 | 0 | 1 | 1 | 2 | 2 |
